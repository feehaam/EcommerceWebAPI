...
namespace EcommerceApplication.Migrations
{
    ...
    [Migration("20230610111925_attempt17")]
    partial class attempt17
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApplication.Models.Orders.Order", b =>
                {
                    ...
                    b.HasOne("EcommerceApplication.Models.Orders.PaymentStatus", "Payments")
                        .WithMany()
            ...
            modelBuilder.Entity("EcommerceApplication.Models.Orders.Payment", b =>
                {
                    b.HasOne("EcommerceApplication.Models.Orders.PaymentStatus", null)
                        .WithMany("Payments")
                        .HasForeignKey("PaymentStatusId");
                });
